...
#define EXCITATION_LEVEL_1	(0b00000000)
#define EXCITATION_LEVEL_2	(0b00000110)
#define EXCITATION_LEVEL_3	(0b00000100)
#define EXCITATION_LEVEL_4	(0b00000010)
...
// Settling time cycles options
#define NUM_SET_CYCLES_DEFAULT	(0x00)
#define NUM_SET_CYCLES_2	(0x02)
#define NUM_SET_CYCLES_4	(0x06)
...
class AD5933 {
    public:
        ...
        static bool setSettlingCycles(int, int); 

        // Frequency sweep configuration
        static bool setStartFrequency(unsigned long, bool);
        static bool setIncrementFrequency(unsigned long, bool);
    ...
    private:
        // Private data
        static const unsigned int internalSpeed = 16776000;
	static const unsigned int externalSpeed = 1000;
